...
async function downloadQuestionPaper() {
    ...
    const renderBlock = async (htmlContent, blockWidth, addSpacing = false) => {
        ...
        hiddenContainer.style.margin = '20';
    ...
    // Note HTML
    const noteHtml = `
        <div style="width: ${pageWidth - 2 * margin}mm; font-family: Helvetica; text-align: left; margin-top: 10px;">
    ...
    const tableHeaderHtml = `
        <div style="width: ${pageWidth - 2 * margin}mm; font-family: Helvetica;">
            <table style="width: 100%; border-collapse: collapse; table-layout: fixed; margin: 0; padding: 0;">
                <thead>
                    <tr style="background-color: #f2f2f2;">
                        <th style="padding: 5px; border: 1px solid black; width: 10%; margin: 0;">S. No</th>
                        <th style="padding: 5px; border: 1px solid black; width: 50%; margin: 0;">Question</th>
                        <th style="padding: 5px; border: 1px solid black; width: 10%; margin: 0;">Unit</th>
                        <th style="padding: 5px; border: 1px solid black; width: 15%; margin: 0;">B.T Level</th>
                        <th style="padding: 5px; border: 1px solid black; width: 15%; margin: 0;">CO/PO</th>
                    </tr>
                </thead>
            </table>
        </div>
                ...
                <table style="width: 100%; border-collapse: collapse; table-layout: fixed; margin: 0; padding: 0;">
                    <tbody style="margin: 0; padding: 0;">
                        <tr style="margin: 0; padding: 0;">
                            <td style="padding: 5px; border-top: 0px solid black; border-left: 1px solid black;  border-right: 1px solid black; border-bottom: 1px solid black; width: 10%; margin: 0;">${index + 1}</td>
                            <td style="padding: 5px; border-top: 0px solid black; border-left: 1px solid black;  border-right: 1px solid black; border-bottom: 1px solid black; width: 50%; margin: 0;">
                                ${q.question}
                                ${q.imageDataUrl ? `
                            ...
                            <td style="padding: 5px; border-top: 0px solid black; border-left: 1px solid black;  border-right: 1px solid black; border-bottom: 1px solid black; width: 15%; text-align: center; margin: 0;">${q.btLevel}</td>
                            <td style="padding: 5px; border-top: 0px solid black; border-left: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; width: 15%; text-align: center; margin: 0;">${getCOValue(q.unit)}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
